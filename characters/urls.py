...
from .views import CharacterCreationView, CharacterDetailsView, CharacterListView, CharacterInventory, SpendPoints
...
urlpatterns = [
    ...
    path('spend-points/<int:pk>/', SpendPoints.as_view(), name='spend-points'),
]
